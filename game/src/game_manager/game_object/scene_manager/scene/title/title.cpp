...
{
    IScene::Initialize();
    TitleSound.Load(BGM_ID::TITLE);
    TitleSound.ChangeBGMVolume(BGM_ID::TITLE, m_change_volume);
    TitleSound.Play(BGM_ID::TITLE);
}
